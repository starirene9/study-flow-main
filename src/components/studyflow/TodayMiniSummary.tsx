    ...
    <div className="glass-card rounded-xl p-4 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center">
          ...
          <p className="text-lg font-bold text-primary">{formatTime(summary.totalFocusMinutes)}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-bold text-workout">{formatTime(summary.totalWorkoutMinutes)}</p>
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-bold">{summary.completedCycles}</p>
